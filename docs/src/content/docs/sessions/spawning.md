...
background thread. A regular file doesn't work here — the CLI silently reads nothing from it.
...
'running' job." A two-minute magic number is the thing standing between you and a silently
dropped prompt.

...
module ParameterStore
  ...
  class WriteClientTest < ActiveSupport::TestCase
    ...
    # Net::HTTP class and USED TO KeyError on anything else. That is how delete
    # shipped 500ing while every test here was green — the fake was happy to
    # DELETE and production could not. Asserting against the real transport's own
    # table is what ties the two together.

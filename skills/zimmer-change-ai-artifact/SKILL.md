...
- The MCP entry schema — https://docs.zimmer.tadasant.com/air/mcp-servers/ (+ `docs/public/mcp.schema.json`).
- Adding a runtime (a different axis entirely) — https://docs.zimmer.tadasant.com/extend/agent-harness/

...
- **Staging is not on a public URL.** `infra/terraform/staging.tfvars.example`
  ...
  host `zimmer-staging`. `docs/DEPLOYING_ON_DIGITALOCEAN.md` mentions
...
- `docs/DEPLOYING_ON_DIGITALOCEAN.md` — the full deploy guide.
- `docs/PROVISIONING.md` — branch protection, staging secrets, Tailscale ACLs/tags.

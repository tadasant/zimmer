...
#
# Queue placement is the whole point. `pollers`, `triggers`, `inference`, `maintenance` and
# `default` are exactly the queues recovery mode halts, so a job that lives on any of them would

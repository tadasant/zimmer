...
# `default`, `inference`, `pollers`, `triggers`, `agents`, `auth`, `maintenance` — at negative
# priority right after a cutover. The first four are gated; the long-held `agents`, `auth`, and
# `maintenance` lanes are advisory. It exists because the 2026-08-13 deploy passed every automated

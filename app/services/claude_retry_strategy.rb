...
class ClaudeRetryStrategy
  ...
  # matches none of them is genuinely unknown and worth paging on. Every shipped
  # runtime now answers true; the false branch in
  # ProcessLifecycleManager#runtime_classifies_exits? is there for the next

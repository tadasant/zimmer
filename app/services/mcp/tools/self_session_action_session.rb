    ...
    class SelfSessionActionSession < ActionSession
      ...
      description <<~DESC
        ...
        **Reporting back to your parent:**
        ...
        - Then decide your own ending on its merits. Reporting to your parent is what lets you archive instead of parking in `needs_input`: the first sanctioned reason for parking is lacking the scope or tools to finish AND having no parent to report back to

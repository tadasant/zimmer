...
class FileStorageService
  ...
  # Reclaim a session's stored files (best-effort; never raises).
  #
  ...
  def self.cleanup_for(session_id)
    ...
    Rails.logger.warn("[FileStorageService] cleanup_for skipped invalid session #{session_id.inspect}: #{e.message}")
  end

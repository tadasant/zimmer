...
class HealthController < ApplicationController
  ...
  #
  # This surface has no key to fingerprint, so every visitor lands in the one anonymous
  # bucket: a global cooldown. It fails closed when the cache cannot enforce it, instead of
  # silently waving every action through.
  def cooldown

...
ActiveRecord::Schema[8.1].define(version: 2026_09_12_140000) do
  ...
  create_table "catalog_snapshots", force: :cascade do |t|
    t.jsonb "catalog_shas", default: {}, null: false
    t.datetime "created_at", null: false
  ...
  create_table "logs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["level", "id", "created_at"], name: "index_logs_on_level_and_id_and_created_at"
  ...
  create_table "managed_secret_writes", force: :cascade do |t|
    ...
    t.index ["variable", "created_at"], name: "index_managed_secret_writes_on_variable_and_created_at"
  end
  ...
  create_table "sessions", force: :cascade do |t|
    ...
    t.jsonb "mcp_server_env"
    t.json "mcp_server_env_json_legacy"
    t.jsonb "mcp_server_env_jsonb"
    t.jsonb "mcp_server_headers"
    t.json "mcp_server_headers_json_legacy"
    t.jsonb "mcp_server_headers_jsonb"
    t.jsonb "mcp_servers"
    t.json "mcp_servers_json_legacy"
    t.jsonb "mcp_servers_jsonb"
    t.jsonb "metadata", default: {}
    t.json "metadata_json_legacy"
  ...
  create_table "triggers", force: :cascade do |t|
    ...
    t.datetime "failed_at"
    t.datetime "first_missed_fire_at"
    t.text "goal"
    t.text "last_error"
